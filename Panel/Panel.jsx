      ...
      <div className={`top-panel ${session.look ? 'long-profile' : ''}`}>
        <div className="container left-menu">
          ...
          {userName === 'admin' && (<>
            ...
            <div className={className("/list/firewall/")}>
          ...
          <div className={className("/list/directory/")}>
            <Link to="/list/directory/">{i18n['File Manager']}</Link>
          </div>
          <div className={className("/softaculous/")}><Link to="/softaculous/" target="_blank">{i18n.Apps ?? 'Apps'}</Link>
          </div>
          {userName === 'admin' && (
